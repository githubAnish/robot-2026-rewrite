package org.frogforce503.robot.constants.tuner;
...
public class TunerConstantsProgrammingBot {
    ...
    public static final Slot0Configs steerGains = new Slot0Configs()
        ...
        .withKS(0.1).withKV(2.66)
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    public static final Slot0Configs driveGains = new Slot0Configs()
        .withKP(8.5).withKI(0).withKD(0.1)
        .withKS(0.5).withKV(0.2); //KV 0.0124
    ...
    // Front Left
    public static final int kFrontLeftDriveMotorId = 61;
    public static final int kFrontLeftSteerMotorId = 62;
    public static final int kFrontLeftEncoderId = 8;
    public static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.063720703125);
    public static final boolean kFrontLeftSteerMotorInverted = true;
    public static final boolean kFrontLeftEncoderInverted = false;

    public static final Distance kFrontLeftXPos = Inches.of(10.25);
    public static final Distance kFrontLeftYPos = Inches.of(10.25);

    // Front Right
    public static final int kFrontRightDriveMotorId = 52;
    public static final int kFrontRightSteerMotorId = 53;
    public static final int kFrontRightEncoderId = 54;
    public static final Angle kFrontRightEncoderOffset = Rotations.of(0.44873046875);
    ...
    public static final Distance kFrontRightXPos = Inches.of(10.25);
    public static final Distance kFrontRightYPos = Inches.of(-10.25);

    // Back Left
    public static final int kBackLeftDriveMotorId = 58;
    public static final int kBackLeftSteerMotorId = 59;
    public static final int kBackLeftEncoderId = 60;
    public static final Angle kBackLeftEncoderOffset = Rotations.of(0.091796875);
    public static final boolean kBackLeftSteerMotorInverted = true;
    public static final boolean kBackLeftEncoderInverted = false;

    public static final Distance kBackLeftXPos = Inches.of(-10.25);
    public static final Distance kBackLeftYPos = Inches.of(10.25);

    // Back Right
    public static final int kBackRightDriveMotorId = 55;
    public static final int kBackRightSteerMotorId = 56;
    public static final int kBackRightEncoderId = 57;
    public static final Angle kBackRightEncoderOffset = Rotations.of(-0.03369140625);
    public static final boolean kBackRightSteerMotorInverted = true;
    public static final boolean kBackRightEncoderInverted = false;

    public static final Distance kBackRightXPos = Inches.of(-10.25);
    public static final Distance kBackRightYPos = Inches.of(-10.25);
