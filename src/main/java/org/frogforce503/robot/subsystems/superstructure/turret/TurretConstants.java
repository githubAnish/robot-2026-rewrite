...
public final class TurretConstants {
    ...
    // Assume 6328 params here
    public static final double minAngle = Units.degreesToRadians(-210.0);
    public static final double maxAngle = Units.degreesToRadians(210.0);
