 ...
 */
public class FFSelectCommand<K> extends Command {
  ...
  private final Command m_defaultCommand = Commands.none();
  ...
  public FFSelectCommand(Map<K, Command> commands, Supplier<? extends K> selector) {
