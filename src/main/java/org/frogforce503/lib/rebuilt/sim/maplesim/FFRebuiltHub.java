 ...
 * is active can be determined by using {@link FFArena2026Rebuilt#isActive(boolean)}
 */
public class FFRebuiltHub extends Goal {
    ...
    protected final FFArena2026Rebuilt arena;
     ...
     */
    public FFRebuiltHub(FFArena2026Rebuilt arena, boolean isBlue) {
        super(
                arena,
                Inches.of(47),
                Inches.of(47),
