 ...
 * {@link FFArena2026Rebuilt#outpostDump(boolean)}, thrown at the goal via {@link #throwForGoal()} or
 * {@link FFArena2026Rebuilt#outpostThrowForGoal(boolean)}, or thrown with specific parameters via
 * {@link #throwFuel(Rotation2d, Angle, LinearVelocity)} or {@link FFArena2026Rebuilt#outpostThrow(boolean, Rotation2d,
 * Angle, LinearVelocity)},
 */
public class FFRebuiltOutpost extends Goal {
    ...
    protected FFArena2026Rebuilt arena;
     ...
     */
    public FFRebuiltOutpost(FFArena2026Rebuilt arena, boolean isBlue) {
        super(
                arena,
                Centimeters.of(3),
                Inches.of(21),
